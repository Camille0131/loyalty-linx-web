...
// const nearestUnpaidDate = unpaidPayments.reduce((nearest, current) => {
//   if (current.status) {
//     const currentDate = new Date(current.paymentDate);
//     const diffToday = Math.abs(today - currentDate);
//     const diffNearest = Math.abs(today - nearest.paymentDate);
//     console.log(nearest.paymentDate);

//     return diffToday < diffNearest ? current : nearest;
//   }
//   return nearest;
// }, repayLog[0]);
