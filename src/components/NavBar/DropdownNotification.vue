...
<template>
  <li class="relative list-none m-2" ref="target">
    <router-link
    ...
    <div
      v-show="dropdownOpen"
      class="absolute z-50 -right-27 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark sm:right-0 sm:w-80"
...
.full-screen {
  ...
  z-index: 1000;
  box-shadow: 0 0 10rem rgba(0, 0, 0, 0.2); /* added box shadow */
  display: flex;
  align-items: center;
  margin: 0 auto;
}
