...
<template>
  <header
    class="sticky top-0 z-999 flex w-full bg-white dark:bg-boxdark dark:drop-shadow-none"
  >
    <div
        ...
        <form action="https://formbold.com/s/unique_form_id" method="POST">
          <div class="relative">
            ...
            <input
              ...
              class="w-full xl:w-125 bg-transparent pr-4 pl-9 outline-none border-none"
            />
          </div>
        </form>
      </div>
